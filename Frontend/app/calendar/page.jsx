    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <h1 className="font-display text-2xl sm:text-3xl">Booking calendar</h1>
        ...
        <div className="grid grid-cols-7 gap-1 mb-6">
          {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((d) => (
            <div key={d} className="text-center text-[10px] sm:text-xs text-ledger-creamDim py-2 truncate">{d}</div>
          ))}
          {cells.map((d, i) => {
            ...
            return (
              <button
                ...
                className="h-14 sm:h-20 p-1 sm:p-2 text-left ledger-panel transition-colors min-w-0"
                style={{
